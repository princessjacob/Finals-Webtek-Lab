...
CREATE TABLE `complaint` (
  ...
  PRIMARY KEY (`cID`),
  KEY `sp_idFK_idx` (`spID`),
  KEY `cust_FK_idx` (`custID`),
  KEY `trans_idFK_idx` (`transID`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `customer` VALUES (1,'Mark','Concepcion','vbjkl@nmnm.com','hgrfds','Somewhere, Baguio City','2600','6543276543222','Life is life.'),(2,'tine','tine','tine@gmail.com','tine','tine','2600','123123','tine'),(3,'eng','eng','eng@gmail.com','eng','asasdasd','1234','12344123','eng');
...
DROP TABLE IF EXISTS `sched_available`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `sched_available`
--

LOCK TABLES `sched_available` WRITE;
/*!40000 ALTER TABLE `sched_available` DISABLE KEYS */;
/*!40000 ALTER TABLE `sched_available` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-05-16  6:54:43
