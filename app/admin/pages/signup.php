...
<div class="container" style="margin-top:20vh">
	<div class="row">
		<div class="col-lg-4 col-lg-offset-4">
			<img class="img-responsive" src="../images/happycat.png" style="width:300px; margin: 0 auto;"/>
			<h2 class="text-center">Registration successful, Thank you!</h2>  
			<p class="text-center"><a id="login" class="btn btn-large btn-default btn-outline" href="login.php">Log in to new account</a></p>
		</div>
	</div>
</div>
</body>
